...
<title>ProModel Car Rental  | Car Listing</title>
<!--Bootstrap -->
...
$sql = "SELECT id 
        FROM tblvehicles 
        WHERE (:brand='' OR VehiclesBrand=:brand) 
...
$sql = "SELECT tblvehicles.*, tblbrands.BrandName, tblbrands.id as bid
        ...
        WHERE (:brand='' OR tblvehicles.VehiclesBrand=:brand)
          AND (:fueltype='' OR tblvehicles.FuelType=:fueltype)
...
<?php } 
    ...
    <div class="alert alert-warning" style="margin-top:15px;">
      <strong>Notice:</strong> No cars found for the selected filters.
    </div>
<?php } ?>
</div>
      ...
      <form action="#" method="get">
        <div class="form-group select">
          <select name="brand" class="form-control">
            ...
            foreach($results as $result)
            { ?>  
              <option value="<?php echo htmlentities($result->id);?>" <?php if($brand==$result->id) echo 'selected'; ?>>
