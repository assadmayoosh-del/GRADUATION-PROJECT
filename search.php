...
// حماية: لو دخل الصفحة بدون POST
$searchdata = isset($_POST['searchdata']) ? trim($_POST['searchdata']) : '';
?>
...
<title>ProModel Car Rental  | Search Result</title>
<!--Bootstrap -->
    ...
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>
          ...
          "<?php echo htmlentities($searchdata); ?>"
        </h1>
      </div>
...
if($searchdata == ''){
  ...
  $sql = "SELECT tblvehicles.id
          ...
          WHERE tblvehicles.VehiclesTitle LIKE :search
             ...
             OR CAST(tblvehicles.ModelYear AS CHAR) LIKE :search";
...
<?php } } else { ?>
    <div class="alert alert-warning">No cars found for this keyword.</div>
<?php } } else { ?>
    <div class="alert alert-info">Please enter a keyword to search.</div>
<?php } ?>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          ...
          <div class="sidebar_filter">
            ...
            <!-- فلتر بسيط (بدون ما يخرب بحث الكلمة) -->
...
if($query->rowCount() > 0){
  foreach($brands as $b){ ?>
    <option value="<?php echo htmlentities($b->id);?>">
      <?php echo htmlentities($b->BrandName);?>
    </option>
<?php } } ?>
                </select>
              </div>
